    ...
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <p class="auth-description">Please sign-in to your account and continue to the dashboard.<br>Don't have an
                account? <a href="register.php">Sign Up</a></p>

            <!-- login success php code -->
            ...
            <!-- email or password worng show sms -->
            ...
            <form action="login_post.php" method="POST">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="email" name="email" class="form-control m-b-md" id="signInEmail"
                        aria-describedby="signInEmail" placeholder="Your email"
                        value="<?= (isset($_SESSION["email"])) ? ($_SESSION["email"]) : '' ?>">

                    <label for="signInPassword" class="form-label">Password</label>
                    <input type="password" name="password" id="pass" class="form-control" id="signInPassword"
                        aria-describedby="signInPassword" placeholder="Type your password">
                    <div class="mt-3">
